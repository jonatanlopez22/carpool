...
public class UserController {
    ...
    public ResponseEntity<User> getUserByUsernameAndPaswordAndRol(String username,String password,int rol) {
    ...
    public ResponseEntity<Iterable<User>>getUserByRol(int rol){

        return new ResponseEntity<Iterable<User>>(userRepository.findByRol(rol), HttpStatus.ACCEPTED);
    }
